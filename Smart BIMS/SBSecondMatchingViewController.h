//
//  SBSecondMatchingViewController.h
//  Smart BIMS
//
...
#define kBarcodeSample1TextField    11
#define kBarcodeSample2TextField    12
#define kBarcodeSample3TextField    13
#define kBarcodeSample4TextField    14
#define kBarcodeSample5TextField    15
...
#define kMatchingSecondStepEquipIdPassAletViewTag      104      // iOS7부터는 ActionSheet 대신 AlertView를 쓰기로 했음. 신규 tag는 AlertView로...
...
@interface SBSecondMatchingViewController : UIViewController <UITextFieldDelegate, UIActionSheetDelegate, UIAlertViewDelegate, UIScrollViewDelegate>
{
