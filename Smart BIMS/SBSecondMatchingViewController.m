...
@implementation SBSecondMatchingViewController
...
{
    TRACE(@"SBSecondMatchingViewController pageReset occurred!");
...
- (void)didReceiveAssetNoInfo:(id)result
{
    ...
    if([strOrgCodeChk isEqualToString:@"T"] == YES){
        if([strBldChk isEqualToString:@"T"] == YES){
            ...
            strAlertMsg = @"채혈장비와 헌혈종류가 일치하지 않습니다.";
...
{ 
    ...
    switch(nTag){
        ...
        case kBarcodeAssetNo :
            ...
            break;
        case kBarcodeSample1TextField :
            if(mstrInput.length > 12) bReturn = NO;
            break;
        case kBarcodeSample2TextField :
            if(mstrInput.length > 12) bReturn = NO;
            break;
        case kBarcodeSample3TextField :
            if(mstrInput.length > 12) bReturn = NO;
            break;
        case kBarcodeSample4TextField :
            if(mstrInput.length > 12) bReturn = NO;
            break;
        case kBarcodeSample5TextField :
            if(mstrInput.length > 12) bReturn = NO;
            break;
        default:
            bReturn = NO;
